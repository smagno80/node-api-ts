...
class TestimonialUsageRoute extends BaseRouter<TestimonialUsageController, ValidateMiddlewareDTO> {
  ...
  public initTestimonialUsageRoutes() {
    ...
    this.router.get(`${this.path}/:id`, (req, res) => this.testimonialUsageController.findUsageTestimonialById(req, res));
    ...
    this.router.delete(`${this.path}/:id`, (req, res) => this.testimonialUsageController.deleteUsageTestimonialById(req, res));
  }
}
